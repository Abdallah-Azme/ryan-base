  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-20 bg-slate-900/90 backdrop-blur-md px-4 py-4 border-b border-white/5 flex items-center">
        ...
        <h1 className="text-lg font-bold text-white ml-2 rtl:mr-2 rtl:ml-0">{t('more.about')}</h1>
      </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="bg-slate-800/30 border border-white/5 rounded-2xl p-5 backdrop-blur-sm">
          <p className="text-sm text-slate-300 leading-relaxed mb-4">
            Raiyansoft is a leading software development company based in Kuwait, specializing in mobile applications, web platforms, and enterprise solutions.
          </p>
          <p className="text-sm text-slate-300 leading-relaxed">
            We empower businesses with cutting-edge technology, from e-commerce platforms to custom CRM systems, ensuring scalability and performance.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <a href="mailto:support@raiyansoft.com" className="flex items-center space-x-3 rtl:space-x-reverse p-3 bg-slate-800/40 rounded-xl border border-white/5 hover:bg-slate-800 transition-colors">
              <Mail size={18} className="text-primary" />
              <span className="text-sm text-slate-300">support@raiyansoft.com</span>
            </a>
            <a href="https://raiyansoft.com" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 rtl:space-x-reverse p-3 bg-slate-800/40 rounded-xl border border-white/5 hover:bg-slate-800 transition-colors">
