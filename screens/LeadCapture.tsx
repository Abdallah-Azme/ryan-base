...
const LeadCapture: React.FC = () => {
  ...
  // Render wizard in "Lead Mode"
  // onClose logic: Refresh or redirect to main site. For now, simple reload.
  return (
    <ProjectWizard 
      onClose={() => window.location.href = 'https://raiyansoft.com'}
