  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-20 bg-slate-900/90 backdrop-blur-md px-4 py-4 border-b border-white/5 flex items-center shadow-lg">
        ...
        <h1 className="text-lg font-bold text-white ml-2 rtl:mr-2 rtl:ml-0">{t('more.terms')}</h1>
      </div>

      <div className="p-6">
        <div className="bg-slate-800/30 border border-white/5 rounded-2xl p-6 backdrop-blur-sm">
          <Section title="1. Acceptance of Terms">
            <p>By downloading, installing, or using the Raiyansoft® application, you agree to be bound by these Terms of Use. If you do not agree, please do not use our services.</p>
          </Section>

          <Section title="2. Account Registration">
            <p>You may be required to register an account. You agree to provide accurate information and keep your account credentials secure. You are responsible for all activities under your account.</p>
          </Section>

          <Section title="3. User Content">
            <p>You retain ownership of content you submit. By submitting content, you grant us a license to use it to provide our services. Do not submit illegal or offensive material.</p>
          </Section>

          <Section title="4. Prohibited Use">
            <p>You may not use the app for any illegal purpose, to harass others, or to interfere with the app's operation. Reverse engineering is strictly prohibited.</p>
          </Section>
          ...
          <Section title="6. Limitation of Liability">
            <p>Raiyansoft® shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service.</p>
          </Section>
