    ...
    >
      ...
      <div className="sticky top-0 z-20 bg-slate-900/90 backdrop-blur-md px-4 py-4 border-b border-white/5 flex items-center">
        <button 
          ...
          className="p-2 -ml-2 text-slate-400 hover:text-white transition-colors rtl:rotate-180"
        >
          <ChevronLeft size={24} />
        </button>
        <h1 className="text-lg font-bold text-white ml-2 rtl:mr-2 rtl:ml-0">{t('more.settings')}</h1>
      </div>
