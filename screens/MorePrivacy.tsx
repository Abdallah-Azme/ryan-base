  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-20 bg-slate-900/90 backdrop-blur-md px-4 py-4 border-b border-white/5 flex items-center shadow-lg">
        ...
        <h1 className="text-lg font-bold text-white ml-2 rtl:mr-2 rtl:ml-0">{t('more.privacy')}</h1>
      </div>
      ...
      <div className="p-6">
        <div className="bg-slate-800/30 border border-white/5 rounded-2xl p-6 backdrop-blur-sm text-sm text-slate-300 leading-relaxed space-y-6">
          ...
          <section>
            ...
            <p>Raiyansoft® (“we”, “us”) values your privacy. This Privacy Policy explains what information we collect, how we use it, and the choices you have.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-slate-400 mb-2">
              ...
              <li>Marketing and advertising partners to help measure campaigns and deliver relevant marketing, subject to your choices and applicable laws.</li>
            </ul>
            <p>We do not disclose personal information for third-party direct marketing where prohibited by law, and we provide choices where required.</p>
          </section>

          <section>
            <h3 className="text-white font-bold mb-2">5. Marketing Choices</h3>
            <p>You may opt out of promotional communications at any time by using unsubscribe options (if available) or contacting us. Some service messages are non-promotional and may still be sent.</p>
          </section>

          <section>
            <h3 className="text-white font-bold mb-2">6. Data Retention</h3>
            <p>We retain information as long as needed for the purposes described, unless a longer retention period is required by law.</p>
          </section>

          <section>
            <h3 className="text-white font-bold mb-2">7. Security</h3>
            <p>We use reasonable administrative, technical, and organizational measures designed to protect your information. No method of transmission or storage is 100% secure.</p>
          </section>

          <section>
            <h3 className="text-white font-bold mb-2">8. International Transfers</h3>
            <p>Your information may be processed in countries other than your own, which may have different data protection laws.</p>
          </section>
          ...
          <section>
            ...
            <p>Depending on your location, you may have rights to access, correct, delete, or object to certain processing of your information. To request these rights, contact us.</p>
          </section>
          ...
          <section>
            ...
            <p>For privacy questions, contact: <span className="text-primary">privacy@raiyansoft.com</span></p>
          </section>
